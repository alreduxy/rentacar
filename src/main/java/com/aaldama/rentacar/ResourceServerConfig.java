...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/manufacturers/**").hasAuthority("ROLE_ADMIN")
                .antMatchers("/menus/**").permitAll()
                .antMatchers("/models/**").permitAll()
                .antMatchers("/rental-status/**").hasAuthority("ROLE_ADMIN")
                .antMatchers("/role/**").hasAuthority("ROLE_ADMIN")
                .antMatchers("/tokens/**").permitAll()
                .antMatchers("/users/**").permitAll()
                .antMatchers(HttpMethod.GET,"/vehicles/**").permitAll()
                .antMatchers("/vehicles/**").permitAll()
                .antMatchers("/vehicle-rented/**").permitAll()
                .antMatchers("/vehicle-rented/rentados/**").permitAll()
                .antMatchers("/vehicle-rented/rentados/{id}").permitAll()
